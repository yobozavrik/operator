                        ...
                        >
                            ...
                            <div className="mt-1 relative z-10 flex w-full h-full items-center justify-center">
                                <div className="text-center">
                                    <div className="text-[9px] text-[#A855F7] font-bold mb-0.5">🥟 ВСЬОГО</div>
                                    <div className="flex items-baseline justify-center gap-1">
                                        <span className="text-2xl font-bold tracking-tight font-[family-name:var(--font-jetbrains)] text-white">
                        ...
                        <div className="glass-panel p-4 rounded-2xl relative overflow-hidden group hover:shadow-[0_0_20px_rgba(0,224,255,0.15)] hover:border-[#00E0FF]/30 transition-all duration-300 bg-[#131B2C]/50">
                            ...
                            <div className="mt-1 flex w-full h-full items-center justify-center">
                                <div className="text-center">
                                    <div className="text-[9px] text-[#A855F7] font-bold mb-0.5">🥟 ВСЬОГО</div>
                                    <div className="flex items-baseline justify-center gap-1">
                                        <span className={cn("text-2xl font-bold tracking-tight drop-shadow-sm font-[family-name:var(--font-jetbrains)]", getIndexColor(globalMetrics.total.index))}>
