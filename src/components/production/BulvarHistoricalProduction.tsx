            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Аналітика цеху Автовокзал</p>
                    </div>
                </div>
                            ...
                            {data.rows.map((row) => (
                                <div key={row.product_id} className="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-white/[0.02] transition-colors group">
                                    <div className="col-span-5">
                                        <div className="text-sm font-bold text-white/90 group-hover:text-blue-400 transition-colors">{row.product_name}</div>
                                        <div className="text-[9px] text-white/20 uppercase font-black mt-1">ID: {row.product_id}</div>
                                    </div>
                                    <div className="col-span-2 text-center">
                                        <div className="text-lg font-mono font-black text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.3)]">
