...
export default function StoreDynamicPage() {
    ...
    return (
        <div className="h-screen bg-bg-primary text-text-primary font-sans flex flex-col overflow-hidden selection:bg-[#00E0FF]/30">
            {/* Fonts Injection (Needed if not loaded globally in layout) */}
            <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;900&family=Rajdhani:wght@400;500;600;700&display=swap" rel="stylesheet" />
