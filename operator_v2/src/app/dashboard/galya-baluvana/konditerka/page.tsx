...
import { KonditerkaFinancialDashboard } from '@/components/analytics/KonditerkaFinancialDashboard';
...
export default function KonditerkaDashboardPage() {
            ...
            <div className="flex-shrink-0 border-b border-white/10 bg-[#0B0F19]/80 backdrop-blur-xl p-4 md:px-6 z-[60]">
                <div className="flex items-center justify-between max-w-[1920px] mx-auto">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white uppercase tracking-widest">Кондитерка Дашборд</h2>
