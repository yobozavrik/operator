...
export const GRAVITON_SHOPS = [
    ...
    { id: 5, name: "Гравітон" },
    { id: 6, name: "Руська" },
    { id: 7, name: "Комарова 26 круг" },
    { id: 8, name: "Героїв Майдану" },
    { id: 9, name: "Ентузіастів" },
    { id: 10, name: "Садгора" },
    { id: 11, name: "Сторожинець" },
    { id: 12, name: "Черемош" },
    { id: 13, name: "Київ" },
    { id: 14, name: "Рівненська" },
    { id: 15, name: "Садова" },
    { id: 16, name: "Хотинська" },
    { id: 17, name: "Компас" },
    { id: 18, name: "Клуб" },
    { id: 19, name: "Мікрорайон" },
...
export const transformKonditerkaData = transformPizzaData;
