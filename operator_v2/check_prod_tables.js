...
async function run() {
    const q1 = `SELECT * FROM bakery1.bread_plan LIMIT 1`;
    const q2 = `SELECT * FROM public.v_graviton_plan_d1 LIMIT 1`;
    ...
    try {
        ...
        console.log("bakery1.bread_plan:", await r1.json());
        ...
        console.log("v_graviton_plan_d1:", await r2.json());
